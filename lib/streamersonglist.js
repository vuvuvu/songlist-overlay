  ...
  container.html(`
    <div class="current-song">
      ...
      <div class="current-song-info">
        ...
        <div class="song-requester current">Requested by: ${song.requester || 'Anonymous'}</div>
      </div>
    </div>
  `);
}
        ...
        const songDiv = $(`
          <div class="cycling-song fade-in">
            ...
            <div class="queue-song-info">
              ...
              <div class="song-requester queue">Requested by: ${song.requester || 'Anonymous'}</div>
            </div>
          </div>
        `);
